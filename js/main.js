...
(function() {
	const homeBeautyLink = document.getElementById("homeBeautyLink");
	const homeGalleryLink = document.getElementById("galleryLink");
	const beautyLink = "https://mirror-react.vercel.app/homebeauty";
	const galleryLink = "https://mirror-react.vercel.app/gallery";
	homeBeautyLink.setAttribute("href", beautyLink);
	homeGalleryLink.setAttribute("href", galleryLink);

	Sortable.create(simpleList, {
		animation: 300,
		easing: "cubic-bezier(1, 0, 0, 1)",
		ghostClass: "shadow-hidden"
	});
})();
